...
def run2():
   ...
   # Run a simulation until all vehicles have arrived
    while traci.simulation.getMinExpectedNumber() > 0:
        ...
        df.to_csv("Output_Dataset/1800V_DS_Sum_wornging_New.csv")
        df2.to_csv("Output_Dataset/1800V_DS_Separated_worning_New.csv")
        df3.to_csv("Output_Dataset/1800V_DS_Export_dataframe_New.csv")
        step +=1
...
if __name__ == "__main__":
    ...
    traci.start([sumoBinary, "-c", "SUMO_Networks\Miami_Test6_1800V_IDM_warningcollect.sumocfg",
                            "-X", "never", 
    ...
    DataBase.to_csv("Output_Dataset\1800V_DS_Sum_wornging_New.csv")
    DataBase2.to_csv("Output_Dataset\1800V_DS_Separated_worning_New.csv")
    DataBase3.to_csv("Output_Dataset\1800V_DS_Export_dataframe_New.csv")
